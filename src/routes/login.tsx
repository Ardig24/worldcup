...
export const Route = createFileRoute('/login')({
  head: () => ({
    meta: [
      { title: 'Login — ScoreBattle' },
      { name: 'description', content: 'Sign in to your ScoreBattle account' },
    ],
  }),
  component: Login,
})
      ...
      <div className="min-h-screen flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <Eyebrow tone="tomato">Welcome back</Eyebrow>
            <h1 className="mt-4 font-display font-black text-5xl leading-[0.95]">
              Sign in to<br />
              <span className="italic">ScoreBattle.</span>
            </h1>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-muted-foreground">
            ...
            <Link to="/signup" className="text-foreground font-medium underline hover:text-tomato">
              Sign up
            </Link>
          </p>
        </div>
